...
<div>
    ...
    <section class="admin-panel product-personalization-panel" data-personalization-options-panel>
        <div class="panel-head"><div><p class="eyebrow">PERSONALIZARE</p><h2>Opțiuni personalizate pentru produs</h2><p class="help">Configurează tipurile de personalizare și costul fiecăruia. Când clienta alege una, va completa numele copilului și data botezului/nașterii.</p></div><button type="button" class="admin-button secondary" data-add-personalization-option>+ Adaugă personalizare</button></div>
        <div class="personalization-admin-note"><span aria-hidden="true">Aa</span><p><strong>Detaliile rămân atașate produsului comandat</strong><small>În comandă vei vedea opțiunea aleasă, numele copilului, data botezului/nașterii și mesajul complet pentru atelier.</small></p></div>
        <div class="product-personalization-option-list" data-personalization-option-list>
            <?php foreach($personalizationOptions as $personalizationOption): ?><article class="product-personalization-option-row" data-personalization-option-row>
                ...
                <label><span>Denumirea personalizării</span><input name="personalization_option_name[]" value="<?= e($personalizationOption['name']) ?>" placeholder="Ex: Broderie cu nume și data botezului/nașterii"></label>
