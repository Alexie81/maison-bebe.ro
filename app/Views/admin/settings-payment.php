...
<section class="admin-panel stripe-test-status">
  ...
  <form method="post" action="<?= e(url('/admin/setari/plati/stripe/wallets')) ?>" class="stripe-wallet-action"><?= csrf_field() ?><div><strong>Plăți rapide pe telefon</strong><small>Stripe afișează wallet-ul numai pe dispozitivele compatibile.</small></div><button class="admin-button secondary" type="submit">Activează Apple Pay și Google Pay</button></form>
</section>
<?php endif; ?>
