        ...
        <article class="cart-row <?= $isGiftBox?'cart-row-gift-box':'' ?>" data-cart-item="<?= (int)$item['id'] ?>">
            ...
            <div class="cart-row-main">
                <?php if($isGiftBox): ?>
                    ...
                    <?php if($components): ?><details class="gift-cart-components" open><summary>Conținut și specificații</summary><ul><li><span>Cutie cadou: <?= e($custom['template_name']??$item['name']) ?></span><small><?= (int)$item['quantity'] ?> × <?= money((int)$item['price_minor']) ?></small></li><?php foreach($components as $component): ?><li><span><?= e($component['name']??'Produs') ?></span><small><?= e($component['variant_label']?:'Standard') ?> · <?= (int)$component['quantity'] ?> × <?= money((int)($component['price_minor']??0)) ?></small></li><?php endforeach; ?></ul></details><?php endif; ?>
