    ...
    <div class="product-layout">
        ...
        <div class="product-summary">
            ...
            <form data-add-to-cart-form data-ga4-product-detail data-ga4-item="<?= e(json_encode($ga4ProductItem, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)) ?>">
                ...
                <?php if(!empty($personalizationOptions)): ?>
                    <fieldset class="product-personalization-choices" data-product-personalization>
                        ...
                        <div class="personalization-details" data-personalization-details hidden>
                            ...
                            <div><label>Numele copilului *<input name="personalization_child_name" maxlength="120" autocomplete="off" placeholder="Ex: Sofia Maria" data-personalization-child-name></label><label>Data botezului/nașterii *<input type="date" name="personalization_birth_date" min="1900-01-01" data-personalization-birth-date></label></div>
