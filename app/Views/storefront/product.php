    ...
    <div class="product-layout">
        ...
        <div class="product-summary">
            ...
            <form data-add-to-cart-form data-ga4-product-detail data-ga4-item="<?= e(json_encode($ga4ProductItem, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)) ?>">
                ...
                <?php if(!empty($personalizationOptions)): ?><fieldset class="product-personalization-choices" data-product-personalization><legend><span>Personalizează produsul</span><small>Opțional</small></legend><p class="personalization-choice-intro">Alege o personalizare, apoi completează exact datele care vor fi lucrate în atelier.</p><div class="personalization-choice-list"><label><input type="radio" name="personalization_option_id" value="0" data-personalization-option data-extra-price="0" checked><span class="personalization-choice-check" aria-hidden="true"></span><span class="personalization-choice-copy"><strong>Fără personalizare</strong><small>Produsul rămâne în forma standard</small></span></label><?php foreach($personalizationOptions as $personalizationOption): $personalizationPrice=(int)$personalizationOption['price_delta_minor']; ?><label><input type="radio" name="personalization_option_id" value="<?= (int)$personalizationOption['id'] ?>" data-personalization-option data-extra-price="<?= $personalizationPrice ?>"><span class="personalization-choice-check" aria-hidden="true"></span><span class="personalization-choice-copy"><strong><?= e($personalizationOption['name']) ?></strong><small>Numele copilului și data nașterii vor fi cerute mai jos</small></span><?php if($personalizationPrice>0): ?><b class="personalization-choice-price">+ <?= money($personalizationPrice) ?></b><?php endif; ?></label><?php endforeach; ?></div><div class="personalization-details" data-personalization-details hidden><div class="personalization-details-head"><span aria-hidden="true">✦</span><p><strong>Datele pentru atelier</strong><small>Verifică atent scrierea înainte de adăugarea în coș.</small></p></div><div><label>Numele copilului *<input name="personalization_child_name" maxlength="120" autocomplete="off" placeholder="Ex: Sofia Maria" data-personalization-child-name></label><label>Data nașterii *<input type="date" name="personalization_birth_date" min="1900-01-01" max="<?= date('Y-m-d') ?>" data-personalization-birth-date></label></div><p class="personalization-preview" data-personalization-preview>Mesajul pentru personalizare va apărea aici.</p></div></fieldset><?php endif; ?>
