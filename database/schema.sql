...
CREATE TABLE IF NOT EXISTS products (
    ...
    stripe_test_product_id VARCHAR(100) NULL,
    stripe_test_synced_at DATETIME NULL,
    stripe_test_sync_error VARCHAR(500) NULL,
    ...
    care_html TEXT NULL,
    shipping_html MEDIUMTEXT NULL,
    gift_wrap_html MEDIUMTEXT NULL,
...
CREATE TABLE IF NOT EXISTS product_variants (
    ...
    stripe_synced_at DATETIME NULL,
    stripe_sync_error VARCHAR(500) NULL,
    stripe_test_price_id VARCHAR(100) NULL,
    stripe_test_price_minor BIGINT NULL,
    stripe_test_synced_at DATETIME NULL,
    stripe_test_sync_error VARCHAR(500) NULL,
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    coupon_code VARCHAR(80) NULL,
    gift_message TEXT NULL,
    ga_client_id VARCHAR(120) NULL,
    ga_session_id VARCHAR(120) NULL,
