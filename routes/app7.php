...
$router->get('/admin/facturare/efactura/conectare/{id}', [BillingController::class, 'connectEfactura'], ['admin']);
...
$router->post('/admin/facturi/{id}/spv', [BillingController::class, 'submitToSpv'], ['admin', 'csrf']);
