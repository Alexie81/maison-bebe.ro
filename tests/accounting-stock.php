...
try{
    ...
    $assert((string)$document['exchange_rate']==='5.000000'&&(string)$document['exchange_rate_source']==='Manual'&&(string)$document['exchange_rate_date']==='2001-02-01','Cursul istoric introdus manual nu a fost păstrat cu sursa și data facturii.');
