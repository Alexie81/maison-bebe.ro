...
<header class="site-header" data-header>
    <div class="header-inner shell">
        ...
        <nav class="header-actions" aria-label="Acțiuni cont și cumpărături">
            ...
            <a class="icon-button account-link" href="<?= e(url($authUser ? '/cont' : '/cont/autentificare')) ?>"><svg aria-hidden="true" viewBox="0 0 24 24"><circle cx="12" cy="7" r="3"/><path d="M6.5 19c.5-4 2.3-6 5.5-6s5 2 5.5 6z"/></svg><span class="sr-only">Cont</span></a>
