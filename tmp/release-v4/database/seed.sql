...
INSERT INTO pages (id, slug, title, content_html, status, robots_index, meta_title, meta_description, published_at) VALUES
    (1,'despre-noi','Despre Maison Bébé','<p>Maison Bébé este un atelier de daruri și obiecte delicate pentru începuturi prețioase.</p><h2>Eleganță, delicatețe, atenție la fiecare detaliu.</h2><p>Alegem materiale naturale și pregătim fiecare comandă cu grijă.</p>','published',1,'Despre Maison Bébé','Povestea și valorile Maison Bébé.',NOW()),
